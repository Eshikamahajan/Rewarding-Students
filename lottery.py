...
df=pd.read_csv("awards_git.csv",encoding="ISO-8859-1")
...
Products_list_4= df_true_4["Full Name"].tolist()
...
Products_list_1= df_true_1["Full Name"].tolist()
...
Products_list_2 = df_true_2["Full Name"].tolist()
...
Products_list_3 = df_true_3["Full Name"].tolist()
...
for i in range(0,21):
    df_final=df[(df["Full Name"]==final_list[i])]
